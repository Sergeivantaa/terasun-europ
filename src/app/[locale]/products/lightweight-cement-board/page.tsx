            ...
            <section>
              ...
              <div className="space-y-4">
                {[
                  ...
                  { q: 'Is Terasun Europe the manufacturer?', a: 'No. Terasun Europe is the Authorised European Representative for Zhejiang Terasun Air Duct Co., Ltd. (China). We support customers across Europe with product information, technical assistance and communication with the manufacturer. Products are manufactured in Zhejiang Province, China.' },
                ].map((faq, i) => (
